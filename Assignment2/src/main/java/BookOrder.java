 ...
 * Date:        02-May-2024
 * Purpose:     This file contains the BookOrder class.
 **********************************************************************************************************
 */
...
public class BookOrder implements Task, Serializable{
    ...
    public BookOrder(double qty,double price1){
        quantity=qty;
        price=price1;
        tax=0.0;
        bill=0.0;
    ...
    public Object getResult(){
        return String.format("Number of Books: %.2f    Price: %.2f    Tax: %.2f    Bill Total for Book: %.2f", quantity, price, tax, bill);
    }
}